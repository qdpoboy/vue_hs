...
def getPage(page):
	...
	if json_data['status'] == 'success':
		...
		sql = "insert into hs_card (name,career,card_set,card_type,cost,race,atk,health,rarity,windfury,taunt,freeze,battlecry,stealth,combo,charge,grant_charge,spellpower,silence,enrage,divine_shield,deathrattle,secret,mission,img_url,card_url) values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
		...
		print "第" + str(page) + "条获取失败" + json_data['status']
